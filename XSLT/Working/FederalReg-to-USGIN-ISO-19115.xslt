						...
						<gmd:MD_Identifier>
							<gmd:code>
								...
								<xsl:value-of select="topics"/>								
											...
											<xsl:if test="string-length(docket_ids)>0">
							<gmd:identifier>
						<gmd:MD_Identifier>
							<gmd:code>
								<gco:CharacterString>
								<xsl:value-of select="docket_ids"/>								
								 </gco:CharacterString>
							</gmd:code>
						</gmd:MD_Identifier>
					</gmd:identifier>		
			...
			<gmd:MD_DigitalTransferOptions>
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							<gmd:URL>
							<xsl:value-of select="body_html_url"/>
							</gmd:URL>
							</gmd:linkage>
							<gmd:name>
								<gco:CharacterString>
				...
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							...
							<gmd:URL>
							<xsl:value-of select="raw_text_url"/>
							</gmd:URL>
				...
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							...
							<gmd:URL>
							<xsl:value-of select="public_inspection_pdf_url"/>
							</gmd:URL>
				...
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							...
							<gmd:URL>
							<xsl:value-of select="full_text_xml_url"/>
							</gmd:URL>
				...
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							...
							<gmd:URL>
							<xsl:value-of select="comment_url"/>
							</gmd:URL>
				...
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							...
							<gmd:URL>
							<xsl:value-of select="abstract_html_url"/>
							</gmd:URL>
				...
				<gmd:onLine>
					<gmd:CI_OnlineResource>
						<gmd:linkage>
							...
							<gmd:URL>
							<xsl:value-of select="regulations_dot_gov_url"/>
							</gmd:URL>
