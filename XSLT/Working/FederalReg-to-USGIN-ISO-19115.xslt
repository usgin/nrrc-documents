...
<xsl:stylesheet version="1.0" exclude-result-prefixes="fn xs xsi xsl usgin" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.isotc211.org/2005/gmd" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:usgin="http://resources.usgin.org/xslt/ISO2USGINISO" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xs="http://www.w3.org/2001/XMLSchema" xsi:schemaLocation="http://www.isotc211.org/2005/gmd http://schemas.opengis.net/csw/2.0.2/profiles/apiso/1.0.0/apiso.xsd">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes"/>
	<xsl:param name="metadataMaintenanceNote" select="'This metadata record has been processed by the NRRC USGIN iso-19115-to-usgin-19115-data XSLT to ensure that all mandatory content for USGIN profile has been added.'"/>
		...
		<gmd:MD_Metadata xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.isotc211.org/2005/gmd http://schemas.opengis.net/csw/2.0.2/profiles/apiso/1.0.0/apiso.xsd">
				...
				<gmd:MD_DataIdentification>
					<gmd:citation>
						<gmd:CI_Citation>
							...
							<!-- agencies-->
							<xsl:choose>
								<xsl:when test="root/agencies">
									<xsl:for-each select="root/agencies/item">
										<gmd:citedResponsibleParty>
											<gmd:CI_ResponsibleParty>
												<xsl:apply-templates select="agencies/item/raw_name"/>
												<gmd:contactInfo>
													<gmd:CI_Contact>
				...
				<gmd:MD_Distribution>
					<gmd:distributor>
						<gmd:MD_Distributor>
							...
							<xsl:if test="string-length(dates)>0">
			...
			<gmd:metadataMaintenance>
				<gmd:MD_MaintenanceInformation>
					<xsl:choose>
						<xsl:when test="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:maintenanceAndUpdateFrequency">
							...
							<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:maintenanceAndUpdateFrequency" mode="no-namespaces"/>
						</xsl:when>
						<xsl:otherwise>
							<gmd:maintenanceAndUpdateFrequency>
								<!--no update frequency in source metadata, USGIN XSLT inserted 'irregular' as a default -->
								<gmd:MD_MaintenanceFrequencyCode codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_MaintenanceFrequencyCode" codeListValue="IRREGULAR">irregular
								</gmd:MD_MaintenanceFrequencyCode>
							</gmd:maintenanceAndUpdateFrequency>
						</xsl:otherwise>
					</xsl:choose>
					<!--<xsl:copy-of select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:dateOfNextUpdate"/>-->
					<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:dateOfNextUpdate" mode="no-namespaces"/>
					...
					<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:userDefinedMaintenanceFrequency" mode="no-namespaces"/>
					<!-- <xsl:copy-of
                        select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:updateScope"/>-->
					<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:updateScope" mode="no-namespaces"/>
					<!--  <xsl:copy-of
                        select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:updateScopeDescription"/>-->
					<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:updateScopeDescription" mode="no-namespaces"/>
					<!--<xsl:copy-of select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:maintenanceNote"/>-->
					<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:maintenanceNote" mode="no-namespaces"/>
					<!-- add a note that the record has been processed by this xslt -->
					<gmd:maintenanceNote>
						<gco:CharacterString>
							<xsl:value-of select="concat($metadataMaintenanceNote, '2013-04-04T12:00:00')"/>
						</gco:CharacterString>
					</gmd:maintenanceNote>
					<!--  <xsl:copy-of
                        select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:contact"
                    />-->
					<xsl:apply-templates select="$var_InputRootNode/gmd:metadataMaintenance/gmd:MD_MaintenanceInformation/gmd:contact" mode="no-namespaces"/>
				</gmd:MD_MaintenanceInformation>
			</gmd:metadataMaintenance>
		</gmd:MD_Metadata>
	</xsl:template>
	...
	<xsl:template match="agencies/item/raw_name">
		<gmd:organisationName>
			<gco:CharacterString>
				<xsl:value-of select="agencies/item/raw_name"/>
			</gco:CharacterString>
		</gmd:organisationName>
	</xsl:template>
	...
	<xsl:template name="usgin:citations">
		<xsl:if test="string-length(citation)>0">
			<gmd:identifier>
				<gmd:MD_Identifier>
					<gmd:authority>
						<xsl:attribute name="xlink:href"><xsl:value-of select="'https://www.federalregister.gov#citation'"/></xsl:attribute>
					</gmd:authority>
					<gmd:code>
						<gco:CharacterString>
		...
		<xsl:if test="string-length(mods_url)>0">
			<gmd:identifier>
				<gmd:MD_Identifier>
					<gmd:authority>
						<xsl:attribute name="xlink:href"><xsl:value-of select="'https://www.federalregister.gov#mods_url'"/></xsl:attribute>
					</gmd:authority>
					<gmd:code>
						<gco:CharacterString>
		...
		<xsl:if test="string-length(executive_order_number)>0">
			<gmd:identifier>
				<gmd:MD_Identifier>
					<gmd:authority>
						<xsl:attribute name="xlink:href"><xsl:value-of select="'https://www.federalregister.gov#executive_order_number'"/></xsl:attribute>
					</gmd:authority>
					<gmd:code>
						<gco:CharacterString>
		...
		<xsl:if test="string-length(document_number)>0">
			<gmd:identifier>
				<gmd:MD_Identifier>
					<gmd:authority>
						<xsl:attribute name="xlink:href"><xsl:value-of select="'https://www.federalregister.gov#document_number'"/></xsl:attribute>
					</gmd:authority>
					<gmd:code>
						<gco:CharacterString>
		...
		<xsl:if test="string-length(topics)>0">
			<gmd:identifier>
				<gmd:MD_Identifier>
					<gmd:authority>
						<xsl:attribute name="xlink:href"><xsl:value-of select="'https://www.federalregister.gov#topics'"/></xsl:attribute>
					</gmd:authority>
					<gmd:code>
						<gco:CharacterString>
		...
		<xsl:if test="string-length(docket_ids/item)>0">
			<gmd:identifier>
				<gmd:MD_Identifier>
					<gmd:authority>
						<xsl:attribute name="xlink:href"><xsl:value-of select="'https://www.federalregister.gov#docket_ids'"/></xsl:attribute>
					</gmd:authority>
					<gmd:code>
						<gco:CharacterString>
